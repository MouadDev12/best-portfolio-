...
const AnimatedItem = ({ children, delay = 0, index, onMouseEnter, onClick, inView }) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className="mb-4 cursor-pointer transition-all duration-200 ease-out"
      style={{
    ...
    <div className={`relative w-[500px] ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`p-4 bg-[#111] rounded-lg transition-colors duration-200 ${selectedIndex === index ? 'bg-[#222]' : ''} ${itemClassName}`}>
